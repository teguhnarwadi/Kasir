        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (etMenu.getText().toString().matches("")) {
                    Message.showToast(CreateActivity.this, "Enter Name");
                } else if (etKtg.getText().toString().matches("")) {
                    Message.showToast(CreateActivity.this, "Enter Email");
                } else if (etHarga.getText().toString().matches("")) {
                    Message.showToast(CreateActivity.this, "Enter Password");
                } else {
                    ...
                    FoodController food = new FoodController(CreateActivity.this);
                    Food f = new Food(id, menu, kategori, harga, null);
                    food.store(f);

                    Intent intent = new Intent(CreateActivity.this, DaftarActivity.class);
